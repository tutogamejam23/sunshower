...
namespace Sunshower
{
    ...
    public class Stage : StateMachine<Stage>
    {
        ...
        private void Awake()
        {
            ...
            SceneManager.LoadSceneAsync("StageUIScene", LoadSceneMode.Additive);
        }
    ...
    {
        public event EventHandler<StageResult> OnStageEnded;
        ...
        {
            Debug.Log("Stage End");
            OnStageEnded?.Invoke(this, Result);
        }
